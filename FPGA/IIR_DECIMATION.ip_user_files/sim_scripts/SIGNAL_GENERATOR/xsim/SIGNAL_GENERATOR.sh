...
#
# Script generated by Vivado on Sat Jan 11 18:09:16 -0500 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : SIGNAL_GENERATOR.sh
...
#
# Usage        : SIGNAL_GENERATOR.sh
#                SIGNAL_GENERATOR.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SIGNAL_GENERATOR.sh [-reset_run]
#                SIGNAL_GENERATOR.sh [-reset_log]
#                SIGNAL_GENERATOR.sh [-help]
#
...
export RDI_DATADIR="C:/Xilinx/Vivado/Vivado/2024.2/data"
...
# script info
echo -e "SIGNAL_GENERATOR.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SIGNAL_GENERATOR.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L axi_utils_v2_0_10 -L mult_gen_v12_0_22 -L xbip_dsp48_wrapper_v3_0_6 -L xbip_pipe_v3_0_10 -L floating_point_v7_1_19 -L dds_compiler_v6_0_26 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SIGNAL_GENERATOR xil_defaultlib.SIGNAL_GENERATOR xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SIGNAL_GENERATOR -key {Behavioral:sim_1:Functional:SIGNAL_GENERATOR} -tclbatch cmd.tcl -protoinst "protoinst_files/SIGNAL_GENERATOR.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Xilinx/Vivado/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SIGNAL_GENERATOR.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./SIGNAL_GENERATOR.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: SIGNAL_GENERATOR.sh [-help]\n\
Usage: SIGNAL_GENERATOR.sh [-step]\n\
Usage: SIGNAL_GENERATOR.sh [-lib_map_path]\n\
Usage: SIGNAL_GENERATOR.sh [-reset_run]\n\
Usage: SIGNAL_GENERATOR.sh [-reset_log]\n\
Usage: SIGNAL_GENERATOR.sh [-keep_index]\n\
Usage: SIGNAL_GENERATOR.sh [-noclean_files]\n\n\
